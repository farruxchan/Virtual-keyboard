const keyboard = [113, 119, 101, 114, 116, 121, 117, 105, 111, 112, 91, 93, 97, 115, 100, 102, 103, 104, 106, 107, 108, 59, 39, 92, 122, 120, 99, 
...
document.onkeypress = function (event) {
    ...
    document.querySelector('#keyboard .k-key').forEach(function(element) {
